      ...
      return(
        <>
          <div className='d-flex flex-column' style={styles.menuContainer}>
            <button type="button" className="btn btn-primary my-1 px-5">
            ...
            <div className="drop-down">
              <button className="btn btn-primary dropdown-toggle px-5 my-1" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <Link to="/teacherdashboard/group1" className='text-decoration-none text-reset'>Group 1</Link>
              </button>
              <ul class="dropdown-menu px-4" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="#">Lesson Plans</a></li>
            ...
            <div className="drop-down">
              <button className="btn btn-primary dropdown-toggle px-5 my-1" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <Link to="/teacherdashboard/group1" className='text-decoration-none text-reset'>Group 2</Link>
              </button>
              <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a className="dropdown-item" href="#">Lesson Plans</a></li>
            ...
            <div className="drop-down">
              <button className="btn btn-primary dropdown-toggle px-5 my-1" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <Link to="/teacherdashboard/group1" className='text-decoration-none text-reset'>Group 3</Link>
              </button>
              <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a className="dropdown-item" href="#">Lesson Plans</a></li>
                <li><a className="dropdown-item" href="#">Assignments</a></li>
            ...
            <button type="button" className="btn btn-primary my-1 px-2">
              ...
              <Link to="..." className='text-decoration-none text-reset'>Add Course</Link>
            </button>
          </div>
        </>
      )
