        ...
        <>
          <div className='d-flex flex-column' style={styles.menuContainer}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people me-1" viewBox="0 0 16 16">
              ...
              <Link to="/teacherdashboard/group2" className='text-decoration-none text-reset'>Group 2</Link>
            </button>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people me-1" viewBox="0 0 16 16">
              ...
              <Link to="/teacherdashboard/group3" className='text-decoration-none text-reset'>Group 3</Link>
            </button>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people me-1" viewBox="0 0 16 16">
              ...
              <Link to="/dashboard/assignments" className='text-decoration-none text-reset'>Group 4</Link>          
            </button>
          </div>
        </>
      )
