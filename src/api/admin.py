...
from .models import db, Students, Teachers, Course, StudentCourse, Module, Topic, Resource, Assignments
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(StudentCourse, db.session))
    ...
    admin.add_view(ModelView(Assignments, db.session))
